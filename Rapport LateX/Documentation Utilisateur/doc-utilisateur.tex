...
\begin{itemize}
 \item  \texttt{hadoopPath} était le chemin où vous avez installé Hadoop
 \item  \texttt{inputPath} chemin du dossier parent où se trouvent vos fichiers que vous voulez indexer, les fichiers à indexer doivent obligatoirement être dans un dossier nommé inputFiles
 \item \texttt{dfsInputPath} endroit où vous voulez mettre les fichiers sur le système de fichier Hadoop
...
\end{itemize} 
Puis, compiler et placer le .jar de l'applet dans le dossier \texttt{Page web} en la nommant applet.jar. N'oublier pas de signer l'applet (nécessaire pour lire les fichiers du disque dur et donc pour parcourir l'index).
